...
tmux new -s sam3_install
mkdir -p /data1/Qiuyue/tmp
mkdir -p /data1/Qiuyue/cache/pip
mkdir -p /data1/Qiuyue/conda_envs
mkdir -p /data1/Qiuyue/conda_pkgs

export TMPDIR=/data1/Qiuyue/tmp
export PIP_CACHE_DIR=/data1/Qiuyue/cache/pip
